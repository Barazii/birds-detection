...
def run_pipeline():
    ...
    estimator = Estimator(
        ...
        output_path=os.path.join(os.environ["S3_PROJECT_URI"], "training-step"),
        hyperparameters={
            "base_network":os.environ["BASE_NETWORK"],
            "use_pretrained_model":os.environ["USE_PRETRAINED_MODEL"],
            "num_classes":os.environ["NUM_CLASSES"],
            "mini_batch_size":os.environ["MINI_BATCH_SIZE"],
            "epochs":os.environ["EPOCHS"],
            "learning_rate":os.environ["LEARNING_RATE"],
            "lr_scheduler_step":os.environ["LR_SCHEDULER_STEP"],
            "lr_scheduler_factor":os.environ["LR_SCHEDULER_FACTOR"],
            "optimizer":os.environ["OPTIMIZER"],
            "momentum":os.environ["MOMENTUM"],
            "weight_decay":os.environ["WEIGHT_DECAY"],
            "overlap_threshold":os.environ["OVERLAP_THRESHOLD"],
            "nms_threshold":os.environ["NMS_THRESHOLD"],
            "image_shape":os.environ["IMAGE_SHAPE"],
            "label_width":os.environ["LABEL_WIDTH"],
